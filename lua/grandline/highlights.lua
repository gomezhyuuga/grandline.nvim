...
function M.setup(colors, colors_semantic)
	...
	hi("FloatBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("VertSplit", { fg = c_sem.border_contrast, bg = "NONE" })
	hi("WinSeparator", { fg = c_sem.border_contrast, bg = "NONE" })
	...
	hi("PmenuSbar", { bg = c_sem.scroll_gutter })
	hi("PmenuThumb", { bg = c_sem.scroll_thumb })
	...
	hi("TelescopeBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("NoiceCmdlinePopupBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("FzfLuaBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("FzfLuaHelpBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("BlinkCmpMenuBorder", { fg = c_sem.border, bg = c.calm_belt })
	hi("BlinkCmpMenuSelection", { fg = c.gear_fifth, bg = c_sem.dropdown_item_bg })
	hi("BlinkCmpScrollBarThumb", { bg = c_sem.scroll_thumb })
	hi("BlinkCmpScrollBarGutter", { bg = c_sem.scroll_gutter })
	...
	hi("BlinkCmpDocBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("BlinkCmpSignatureHelpBorder", { fg = c_sem.border, bg = c.calm_belt })
	...
	hi("SnacksPickerBorder", { fg = c_sem.border, bg = c.calm_belt })
